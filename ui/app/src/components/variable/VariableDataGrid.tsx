...
import { CommonRow, DATA_GRID_INITIAL_STATE_SORT_BY_DISPLAY_NAME, DataGridPropertiesWithCallback, DataGridTable } from '@perses-dev/components';
...
export function VariableDataGrid(props: DataGridPropertiesWithCallback<Row>): ReactElement {
  ...
  return (
    <DataGridTable
      ...
      isLoading={isLoading}
      onRowClick={(name, project) => onRowClick(name, project)}
      emptyResource="variables"
